...
from src.examples.app_games.games.base import BaseGame
# Import tool classes needed to resolve properly the config file
from src.examples.app_games.games.fantasia_genesis_tools import (  # pylint: disable=W0611
    SaveWorld,
    SaveHero,
    GetWorld,
    GetHero,
...
CONFIG = Config(
    'src/examples/app_games/config.yaml',
