...
const toolHandlers = {
    'ChatTool': {
        appendDetails: appendChatToolDetails,
        generateSettingsForm: generateChatToolSettingsForm,
        collectSettings: collectChatToolSettings,
        applySettings: applyChatToolSettings
    },
    'RagTool': {
