 ...
 */
function appendChatToolDetails(tool) {
 ...
 */
function generateChatToolSettingsForm(tool) {
    generateChatToolConfigurationForm(tool)
    generateChatToolInterfaceForm(tool)
 ...
 * @param {Object} tool - The tool object containing settings.
 */
function generateChatToolConfigurationForm(tool) {
    let settingsForm = ''
 ...
 * @param {Object} tool - The tool object containing settings.
*/
function generateChatToolInterfaceForm(tool) {
    let manifest = tool.settings.tool
    let settingsForm = `
 ...
 */
function collectChatToolSettings() {
    const settings = {};
 ...
 */
function applyChatToolSettings(toolId, settings) {
...
export {
    appendChatToolDetails,
    generateChatToolSettingsForm,
    collectChatToolSettings,
    applyChatToolSettings
};
