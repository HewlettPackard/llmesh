...
Welcome to LAT-Mesh, a pioneering initiative by HPE Athonet aimed at democratizing Generative Artificial Intelligence (Gen AI). Our vision is to make Gen AI accessible and beneficial to a broader audience, enabling users from various backgrounds to leverage cutting-edge Gen AI technology effortlessly.
...
We have created a series of tools and examples to demonstrate what you can do with LAT-Mesh. To get started, follow these steps to set up your environment, understand the project structure, and run the tools and web applications provided.
...
Before setting up the LAT-Mesh platform, please ensure the following prerequisites are met:
...
#### Option 1: Install LAT-Mesh Services Only

If you only need the core LAT-Mesh services without the example applications, you can install them directly via `pip`:
...
1. **Clone the Repository**: Download the LAT-Mesh repository to your local machine.
