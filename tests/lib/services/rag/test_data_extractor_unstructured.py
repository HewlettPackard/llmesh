...
@patch('src.lib.services.rag.data_extractors.unstructured.sections.FileCache')
@patch('src.lib.services.rag.data_extractors.unstructured.sections.Logger.get_logger')
@patch('src.lib.services.rag.data_extractors.unstructured.sections.partition_docx')
@patch('src.lib.services.rag.data_extractors.unstructured.sections.Document')
...
@patch('src.lib.services.rag.data_extractors.unstructured.sections.FileCache')
@patch('src.lib.services.rag.data_extractors.unstructured.sections.Logger.get_logger')
@patch('src.lib.services.rag.data_extractors.unstructured.sections.partition_pdf')
...
def config():
    ...
    return {
        ...
        "document_type": "Pdf",
        "cache_elements_to_file": False,
        "image_output_folder": "tests/lib/services/rag/test_data/img"
    }

@pytest.fixture
def sample_pdf_path():
    "test path"
    return "tests/lib/services/rag/test_data/sample_pdf_for_test.pdf"
...
def sample_docx_path():
    "test path"
    return "tests/lib/services/rag/test_data/sample_docx_for_test.docx"
...
def sample_html_path():
    "test path for HTML"
    return "tests/lib/services/rag/test_data/sample_html_for_test.html"
...
@pytest.mark.parametrize(
    ...
    [
        ("tests/lib/services/rag/test_data/sample_docx_for_test.docx", "partition_docx"),
        ("tests/lib/services/rag/test_data/sample_pdf_for_test.pdf", "partition_pdf"),
        ("tests/lib/services/rag/test_data/sample_html_for_test.html", "partition_html"),
        ("tests/lib/services/rag/test_data/sample_pptx_for_test.pptx", "partition_pptx"),
        ("tests/lib/services/rag/test_data/sample_xlsx_for_test.xlsx", "partition_xlsx"),
    ],
)
@patch("src.lib.services.rag.data_extractors.unstructured.sections.FileCache")
@patch("src.lib.services.rag.data_extractors.unstructured.sections.Logger.get_logger")
def test_parse_auto_document_type(
    ...
    with patch(
        f"src.lib.services.rag.data_extractors.unstructured.sections.{func_name}"
