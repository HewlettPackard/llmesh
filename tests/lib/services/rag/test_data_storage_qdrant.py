...
@patch('src.lib.services.rag.data_storages.qdrant.collection.QdrantClient')  # Mock QdrantClient
...
@patch('src.lib.services.rag.data_storages.qdrant.collection.QdrantClient')
@patch('src.lib.services.rag.data_storages.qdrant.collection.Logger')
