...
from src.lib.services.rag.data_loaders.chroma.sentences import ChromaForSentenceDataLoader
...
@patch('src.lib.services.rag.data_loaders.chroma.sentences.Logger')
