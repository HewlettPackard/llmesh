...
from libs.services.chat.memories.langchain.chroma_store_retriever import (
    CustomVectorStoreRetrieverMemory
)
from libs.services.chat.memories.langchain.custom_remote import (
    CustomLangChainRemoteMemory,
    LangChainRemoteMemory
)
from libs.services.chat.memories.langchain.buffer import (
    LangChainBufferMemory
)
from libs.services.chat.memories.langchain.buffer_window import (
    LangChainBufferWindowMemory
)
from libs.services.chat.memories.langchain.chroma_store_retriever import (
    LangChainChromaStoreMemory
)
from libs.services.chat.memories.langchain.summary import (
    ...
    (
        {
            ...
            "memory_key": "chat_history",
            "persist_directory": "libs.services/tests/unit/data",
...
@patch('libs.services.chat.memories.langchain.custom_remote.MessageManager.create')
@patch('libs.services.chat.memories.langchain.custom_remote.requests.post')
