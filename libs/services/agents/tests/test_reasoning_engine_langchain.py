...
from libs.services.agents.reasoning_engines.langchain.agent_executor import (
...
def test_create(config, expected_class):
    ...
    """
    with patch(
        'libs.services.agents.reasoning_engines.langchain.agent_executor.LangChainAgentExecutor._init_tool_repository',  # pylint: disable=C0301
        return_value=MagicMock()
    ), patch(
        'libs.services.agents.reasoning_engines.langchain.agent_executor.LangChainAgentExecutor._init_engine',  # pylint: disable=C0301
        return_value=MagicMock()
    ), patch(
        'libs.services.agents.reasoning_engines.langchain.agent_executor.LangChainAgentExecutor._init_executor',  # pylint: disable=C0301
        return_value=MagicMock()
    ):
...
@patch(
    'libs.services.agents.reasoning_engines.langchain.agent_executor.LangChainAgentExecutor.run',  # pylint: disable=C0301
...
@patch(
    'libs.services.agents.reasoning_engines.langchain.agent_executor.LangChainAgentExecutor.clear_memory',  # pylint: disable=C0301
...
@patch(
    'libs.services.agents.reasoning_engines.langchain.agent_executor.LangChainAgentExecutor.set_memory',  # pylint: disable=C0301
    return_value=MagicMock(status="success"))
...
@patch(
    'libs.services.agents.reasoning_engines.langchain.agent_executor.LangChainAgentExecutor.set_tools',  # pylint: disable=C0301
    return_value=MagicMock(status="success"))
