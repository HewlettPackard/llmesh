...
from libs.services.agents.reasoning_engines.llamaindex.react import (
...
def test_create(config, expected_class):
    ...
    """
    with patch(
        'libs.services.agents.reasoning_engines.llamaindex.react.LlamaIndexReActEngine._init_tool_repository',  # pylint: disable=C0301
        return_value=MagicMock()
    ), patch(
        'libs.services.agents.reasoning_engines.llamaindex.react.LlamaIndexReActEngine._init_engine',  # pylint: disable=C0301
        return_value=MagicMock()
    ), patch(
        'libs.services.agents.reasoning_engines.llamaindex.react.LlamaIndexReActEngine._init_executor',  # pylint: disable=C0301
        return_value=MagicMock()
    ):
...
@patch(
    'libs.services.agents.reasoning_engines.llamaindex.react.LlamaIndexReActEngine.run',
...
@patch(
    'libs.services.agents.reasoning_engines.llamaindex.react.LlamaIndexReActEngine.clear_memory',  # pylint: disable=C0301
...
@patch(
    'libs.services.agents.reasoning_engines.llamaindex.react.LlamaIndexReActEngine.set_memory',  # pylint: disable=C0301
    return_value=MagicMock(status="success"))
...
@patch(
    'libs.services.agents.reasoning_engines.llamaindex.react.LlamaIndexReActEngine.set_tools',
