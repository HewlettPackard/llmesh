...
def test_create(config, expected_class):
    ...
    """
    with patch(
        'self_serve_platform.agents.reasoning_engines.llamaindex_react.LlamaIndexReActEngine._init_tool_repository',  # pylint: disable=C0301
        return_value=MagicMock()
    ), patch(
        'self_serve_platform.agents.reasoning_engines.llamaindex_react.LlamaIndexReActEngine._init_engine',  # pylint: disable=C0301
        return_value=MagicMock()
    ), patch(
        'self_serve_platform.agents.reasoning_engines.llamaindex_react.LlamaIndexReActEngine._init_executor',  # pylint: disable=C0301
        return_value=MagicMock()
    ):
...
@patch(
    'self_serve_platform.agents.reasoning_engines.llamaindex_react.LlamaIndexReActEngine.run',
...
@patch(
    'self_serve_platform.agents.reasoning_engines.llamaindex_react.LlamaIndexReActEngine.clear_memory',  # pylint: disable=C0301
...
@patch(
    'self_serve_platform.agents.reasoning_engines.llamaindex_react.LlamaIndexReActEngine.set_memory',  # pylint: disable=C0301
    return_value=MagicMock(status="success"))
...
@patch(
    'self_serve_platform.agents.reasoning_engines.llamaindex_react.LlamaIndexReActEngine.set_tools',
