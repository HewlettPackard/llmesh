    ...
    (
        {
            ...
            "memory_key": "chat_history",
            "persist_directory": "self_serve_platform/tests/unit/data",
...
@patch('self_serve_platform.chat.memories.langchain_remote_memory.MessageManager.create')
@patch('self_serve_platform.chat.memories.langchain_remote_memory.requests.post')
